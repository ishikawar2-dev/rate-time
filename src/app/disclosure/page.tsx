...
export default function DisclosurePage() {
  return (
    <main className="max-w-2xl mx-auto px-4 py-12 text-rt-text-secondary">
      ...
      <h1 className="text-2xl font-bold text-rt-text-primary mb-2">広告に関する表示</h1>
      <p className="text-xs text-rt-text-muted mb-8">最終更新日: 2026-04-24</p>

      <section className="mb-8">
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">アフィリエイトプログラムへの参加</h2>
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">広告表示の方針</h2>
        <ul className="text-sm leading-relaxed text-rt-text-tertiary list-disc pl-5 space-y-2">
          <li>アフィリエイトリンクを含むセクションの直前には必ず「広告」または「PR」の表記を行います（ステマ規制対応）。</li>
          <li>コラム記事で商品・サービスを紹介する場合は、記事冒頭に「本ページにはプロモーションが含まれます」と明示します。</li>
          <li>アフィリエイトリンクには <code className="text-rt-text-secondary">rel=&quot;sponsored nofollow noopener&quot;</code> を付与し、検索エンジンに対しても広告であることを明示します。</li>
          <li>利用者に誤認を与えないよう、体験談・口コミを捏造することはありません。</li>
        </ul>
      </section>

      <section className="mb-8">
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">取り扱うカテゴリ</h2>
        <p className="text-sm leading-relaxed text-rt-text-tertiary mb-2">
          当サイトで紹介するアフィリエイト案件は、以下のカテゴリに限定します。
        </p>
        <ul className="text-sm leading-relaxed text-rt-text-tertiary list-disc pl-5 space-y-1">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">取り扱わないカテゴリ</h2>
        <p className="text-sm leading-relaxed text-rt-text-tertiary mb-2">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">カードローン等に関する注意</h2>
        <p className="text-sm leading-relaxed text-rt-text-tertiary">
          当サイトではカードローン・消費者金融・クレジットカードを紹介する場合がありますが、これらの利用は慎重に検討してください。
          借入は計画的に行い、返済が困難と感じた場合は債務整理などの専門家相談を優先することを推奨します。
        </p>
        <p className="text-sm leading-relaxed text-rt-text-tertiary mt-3">
          借り過ぎに注意しましょう。各サービスの契約条件・金利・返済期間は、必ず提供元の公式情報をご確認ください。
        </p>
      </section>

      <section>
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">計算結果の免責</h2>
        <p className="text-sm leading-relaxed text-rt-text-tertiary">
