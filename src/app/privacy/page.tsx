...
export default function PrivacyPage() {
  return (
    <main className="max-w-2xl mx-auto px-4 py-12 text-rt-text-secondary">
      ...
      <h1 className="text-2xl font-bold text-rt-text-primary mb-2">プライバシーポリシー</h1>
      <p className="text-xs text-rt-text-muted mb-8">最終更新日: 2026-04-24</p>

      <section className="mb-8">
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">1. 取得する情報</h2>
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">2. 利用目的</h2>
        <p className="text-sm leading-relaxed text-rt-text-tertiary">
          取得した情報は以下の目的で利用します。
        </p>
        <ul className="text-sm leading-relaxed text-rt-text-tertiary list-disc pl-5 mt-2 space-y-1">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">3. Cookie の利用</h2>
        <p className="text-sm leading-relaxed text-rt-text-tertiary">
          当サイトは以下の Cookie を利用します。
        </p>
        <ul className="text-sm leading-relaxed text-rt-text-tertiary list-disc pl-5 mt-2 space-y-1">
          <li><code className="text-rt-text-secondary">rt_vid</code>: 訪問者識別のためのランダムな UUID（有効期限 1 年）。個人を特定する情報は含みません。</li>
          <li><code className="text-rt-text-secondary">rt_exp_*</code>: A/Bテストのバリアント割当を記録するための識別子（有効期限 90 日）。</li>
        </ul>
        <p className="text-sm leading-relaxed text-rt-text-tertiary mt-3">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">4. アフィリエイトプログラムへの参加</h2>
        <p className="text-sm leading-relaxed text-rt-text-tertiary">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">5. 第三者提供</h2>
        <p className="text-sm leading-relaxed text-rt-text-tertiary">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-rt-text-primary mb-3">6. 改定</h2>
        <p className="text-sm leading-relaxed text-rt-text-tertiary">
