        ...
        <div className="max-w-2xl mx-auto px-4 py-12">
          ...
          <section className="mb-10">
            ...
            <p className="text-sm leading-relaxed">
              使い方は難しくない。元金と金利を入れるだけだ。ただ「どう活用するか」次第で、数字の見え方と返済行動が変わる。
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-sm leading-relaxed mb-3">
              利息タイマーに「元金」と「実質年率」を入力すると、今この瞬間から積み上がっている利息を秒単位でリアルタイム表示できる。
            </p>
            <p className="text-sm leading-relaxed mb-3">
              まず「今いくら増えているか」を把握することが起点だ。年率15%で100万円なら1日411円、1ヶ月で約12,329円。この数字を見るだけで、利息が抽象的なパーセントから実感できる金額になる。
            </p>
            <p className="text-sm leading-relaxed">
              そこから先は2通りの使い方がある。元金の数字を変えると「繰上返済でいくら減るか」が、金利の数字を変えると「借換えでいくら変わるか」が、それぞれ1日単位で確認できる。次のセクションで具体例を見ていく。
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-sm leading-relaxed mb-3">
              たとえばA社（残高50万円・年率18%）、B社（残高80万円・年率15%）、C社（残高30万円・年率18%）という状況を考える。1日あたりの利息はA社約247円、B社約329円、C社約148円になる。金利だけを見ればAとCが同じ18%だが、残高の差でA社のほうが利息が多い。つまり「金利の高い順」より「1日あたりの利息が多い順」で優先度を判断するほうが正確だ。
            </p>
            <p className="text-sm leading-relaxed">
