        ...
        <div className="max-w-2xl mx-auto px-4 py-12">
          ...
          <section className="mb-10">
            ...
            <p className="text-sm leading-relaxed">
              基本の式はシンプルだ。ただ、その式から何が読み取れるかを理解すると、返済計画への見方が変わる。
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-sm leading-relaxed mb-3">
              各社のウェブサイトや金融庁のツールでは、元金・金利・返済期間を入力すると月々の返済額と総利息が出る。
            </p>
            <p className="text-sm leading-relaxed mb-3">
              見るべきは「月々の返済額」より「総返済額」だ。返済期間が長ければ総利息は膨らむ。100万円・年15%で月々2万円返済の場合、完済まで約64ヶ月かかり総利息は約28万円。月々3万円に増やせば約38ヶ月・総利息約15万円——差は約13万円になる。
            </p>
            <p className="text-sm leading-relaxed mb-3">
              もう一点。シミュレーションは「今日から返済を始める」理想値で、実際には借入日から初回引落日まで数日〜数十日の利息が先に乗ってくる。1回目だけ返済額が多くなる理由はここにある。
            </p>
            <p className="text-sm leading-relaxed">
