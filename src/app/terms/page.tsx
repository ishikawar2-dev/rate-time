  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-12 text-zinc-300">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-zinc-200 mb-3">第1条（適用）</h2>
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-zinc-200 mb-3">第2条（サービス内容）</h2>
        <p className="text-sm leading-relaxed text-zinc-400">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-zinc-200 mb-3">第3条（計算結果の免責）</h2>
        <p className="text-sm leading-relaxed text-zinc-400">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-zinc-200 mb-3">第4条（禁止事項）</h2>
        <p className="text-sm leading-relaxed text-zinc-400">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-zinc-200 mb-3">第5条（URL 共有時の注意）</h2>
        <p className="text-sm leading-relaxed text-zinc-400">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-zinc-200 mb-3">第6条（サービスの変更・中断・終了）</h2>
        <p className="text-sm leading-relaxed text-zinc-400">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold text-zinc-200 mb-3">第7条（アフィリエイトリンクについて）</h2>
        <p className="text-sm leading-relaxed text-zinc-400">
      ...
      <section>
        <h2 className="text-lg font-bold text-zinc-200 mb-3">第8条（準拠法・管轄）</h2>
        <p className="text-sm leading-relaxed text-zinc-400">
